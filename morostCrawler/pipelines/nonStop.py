...
class NonStopPipeline:
    def process_item(self, item, spider):
        ...
        # 图片下载文件夹“E:\Github\morostCrawler\files\nonStop”
        pics_dir = r"E:\Github\morostCrawler\files\nonStop"
        ...
        # 定义文件路径
        file_path = r"E:\Github\morostCrawler\files\nonStop.xlsx"
...
if __name__ == '__main__':
    ...
    # 将HTML保存到文件
    output_path = r'E:\Github\morostCrawler\files\nonStop.html'
