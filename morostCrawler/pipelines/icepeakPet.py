...
class IcepeakPetPipeline:
    def process_item(self, item, spider):
        ...
        # 图片下载文件夹“E:\Github\morostCrawler\files\icepeakPet”
        pics_dir = r"E:\Github\morostCrawler\files\icepeakPet"
        ...
        # 定义文件路径
        file_path = r"E:\Github\morostCrawler\files\icepeakPet.xlsx"
...
if __name__ == '__main__':
    ...
    # 将HTML保存到文件
    output_path = r'E:\Github\morostCrawler\files\icepeakPet.html'
