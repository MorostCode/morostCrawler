...
class ToyFoxPipeline:
    def process_item(self, item, spider):
        if item.__class__.__name__ != "ToyFoxProductItem":
            return item
        logger.info("进入ToyFoxPipeline，开始处理ToyFoxProductItem")
        ...
        data = {
            ...
            "产品描述（主要）": [item['product_description_main']],
            "产品描述（次要）": [item['product_description_side']],
            "产品详情": [item['product_details']]
        }

        # 图片下载文件夹“E:\Github\morostCrawler\files\toyFoxPics”
        pics_dir = r"E:\Github\morostCrawler\files\toyFoxPics"
        ...
        # 定义文件路径
        file_path = r"E:\Github\morostCrawler\files\toyFox.xlsx"
...
if __name__ == '__main__':
    ...
    # 将HTML保存到文件
    output_path = r'E:\Github\morostCrawler\files\toyFox.html'
