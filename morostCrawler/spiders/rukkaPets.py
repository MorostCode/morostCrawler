...
from morostCrawler.items.rukkaPets import RukkaPetsProductItem


# RukkaPets 产品爬虫-----------------------------------------------------------------------------------------------------
class RukkaPetsSpider(scrapy.Spider):
    name = "rukkaPets"
    ...
    def __init__(self, **kwargs):
        ...
        # 初始化爬取链接
        self.start_url = "https://luhta.com/global/en/c/rukka-pets/products"
        # 产品计数
        self.count = 0
        # 产品总数
        self.product_total_num = 0
        logger.info(f"RukkaPetsSpider {self.start_url}")
    ...
    def parse_product_page(self, response, **kwargs):
        # 新建产品item
        product_item = RukkaPetsProductItem()
